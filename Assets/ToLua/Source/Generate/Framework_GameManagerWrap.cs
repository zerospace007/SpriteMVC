...
public class Framework_GameManagerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Framework.GameManager), typeof(Framework.Core.View));
	...
	static int OnMessage(IntPtr L)
	{
		try
		{
			...
			Framework.GameManager obj = (Framework.GameManager)ToLua.CheckObject<Framework.GameManager>(L, 1);
