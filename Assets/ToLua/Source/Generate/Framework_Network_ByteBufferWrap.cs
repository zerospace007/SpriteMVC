...
public class Framework_Network_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Framework.Network.ByteBuffer), typeof(System.Object));
		...
		L.RegFunction("New", _CreateFramework_Network_ByteBuffer);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateFramework_Network_ByteBuffer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				Framework.Network.ByteBuffer obj = new Framework.Network.ByteBuffer();
			...
			else if (count == 1)
			{
				...
				Framework.Network.ByteBuffer obj = new Framework.Network.ByteBuffer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: Framework.Network.ByteBuffer.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Close(IntPtr L)
	{
		try
		{
			...
			Framework.Network.ByteBuffer obj = (Framework.Network.ByteBuffer)ToLua.CheckObject<Framework.Network.ByteBuffer>(L, 1);
			obj.Close();
			return 0;
		}
		catch (Exception e)
