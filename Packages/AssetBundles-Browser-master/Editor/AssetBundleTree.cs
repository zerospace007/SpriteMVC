...
namespace AssetBundleBrowser
{
    internal class AssetBundleTree : TreeView
    {
        ...
        private void CreateNewSiblingFolder(object context)
        {
            ...
            else Debug.LogError("could not add 'sibling' with no bundles selected");
        }
        ...
        private void DragPathsAsOneBundle()
        {
            ...
            AssetBundleModel.Model.MoveAssetToBundle(dragToNewSpacePaths, newBundle.Name.BundleName, newBundle.Name.Variant);
            AssetBundleModel.Model.ExecuteAssetMove();
            ReloadAndSelect(newBundle.NameHashCode, true);
        }
        private void DragPathsAsManyBundles()
        {
            ...
            {
                var newBundle = AssetBundleModel.Model.CreateEmptyBundle(dragToNewSpaceRoot, Path.GetFileNameWithoutExtension(assetPath).ToLower());
                AssetBundleModel.Model.MoveAssetToBundle(assetPath, newBundle.Name.BundleName, newBundle.Name.Variant);
