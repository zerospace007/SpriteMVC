...
namespace AssetBundleBrowser.AssetBundleModel
{
    ...
    public static class Model
    {
        ...
        private static IABDataSource s_DataSource;
        ...
        ///  
        /// </summary>
        public static IABDataSource DataSource
        {
            get
            {
        ...
        internal static void ForceReloadData(TreeView tree)
        {
            ...
            while (!doneUpdating && !s_InErrorState)
            {
                ...
                EditorUtility.DisplayProgressBar("Updating Bundles", s_BundlesToUpdate[currCount - 1].DisplayName, (fullBundleCount - currCount) / (float)fullBundleCount);
                doneUpdating = Update();
            }
        ...
        internal static BundleInfo CreateEmptyBundle(BundleFolderInfo folder = null, string newName = null)
        {
            ...
            nameData = new BundleNameData(folder.Name.BundleName, name);
        ...
        internal static BundleInfo CreateEmptyVariant(BundleVariantFolderInfo folder)
        {
            ...
            string variantName = folder.Name.BundleName + "." + name;
        ...
        internal static BundleFolderInfo CreateEmptyBundleFolder(BundleFolderConcreteInfo folder = null)
        {
            ...
            BundleNameData nameData = new BundleNameData(folder.Name.BundleName, name);
        ...
        private static BundleFolderConcreteInfo AddFoldersToBundle(BundleFolderInfo root, BundleNameData nameData)
        {
            ...
            for (var index = 0; index < size; index++)
            {
                if (folder != null)
                {
                    ...
                    {
                        s_InErrorState = true;
                        LogFolderAndBundleNameConflict(currInfo.Name.FullNativeName);
                        break;
                    }
                }
            }
        ...
        {
            var originalName = new BundleNameData(item.Bundle.Name.FullNativeName);
        ...
        internal static void HandleBundleReparent(IEnumerable<BundleInfo> bundles, BundleFolderInfo parent)
        {
            ...
            foreach (var bundle in bundles)
            {
                bundle.HandleReparent(parent.Name.BundleName, parent);
            }
            ExecuteAssetMove();
        }
        ...
        internal static void HandleBundleMerge(IEnumerable<BundleInfo> bundles, BundleDataInfo target)
        {
            foreach (var bundle in bundles)
            {
                bundle.HandleDelete(true, target.Name.BundleName, target.Name.Variant);
            }
            ExecuteAssetMove();
        }
        ...
        internal static BundleInfo HandleDedupeBundles(IEnumerable<BundleInfo> bundles, bool onlyOverlappedAssets)
        {
            ...
            MoveAssetToBundle(dupeAssets, newBundle.Name.BundleName, string.Empty);
            ExecuteAssetMove();
            return newBundle;
        }
        ...
        {
            bundle.HandleDelete(true, bundle.Name.BundleName, k_NewVariantBaseName);
            ExecuteAssetMove();
            var root = bundle.Parent.GetChild(bundle.Name.ShortName) as BundleVariantFolderInfo;
            ...
            else
            {
                ...
                var vfolder = new BundleVariantFolderInfo(bundle.Name.BundleName, bundle.Parent);
                var vdata = new BundleVariantDataInfo(bundle.Name.BundleName + "." + k_NewVariantBaseName, vfolder);
        ...
        internal static void ExecuteAssetMove(bool forceAct = true)
        {
            ...
            if (forceAct)
            {
                if (size > 0)
                {
                    ...
                    {
                        EditorUtility.DisplayProgressBar("Moving assets to bundle " + s_MoveData[i].bundleName, Path.GetFileNameWithoutExtension(s_MoveData[i].assetName), i / (float)size);
                        s_MoveData[i].Apply();
                    }
                    EditorUtility.ClearProgressBar();
        ...
        internal static Texture2D SceneIcon
        {
            get
            {
                if (s_sceneIcon == null)
        ...
        private static void FindBundleIcons()
        {
            ...
            var packagePath = Path.GetFullPath("Packages/com.unity.assetbundlebrowser");
