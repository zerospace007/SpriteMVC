...
namespace AssetBundleBrowser
{
    ...
    public class AssetBundleBrowserMain : EditorWindow, IHasCustomMenu, ISerializationCallbackReceiver
    {
        ...
        [MenuItem("Game/AssetBundle Browser", priority = 0)]
        ...
        {
            if (m_BuildTab != null) m_BuildTab.OnDisable();
            if (m_InspectTab != null) m_InspectTab.OnDisable();
        }
        ...
        private void ModeToggle()
        {
            ...
            if(multiDataSource)
            {
                ...
                using (new EditorGUILayout.HorizontalScope(EditorStyles.toolbar))
                {
                    ...
                    GUILayout.FlexibleSpace();
                    var content = new GUIContent(string.Format("{0} ({1})", AssetBundleModel.Model.DataSource.Name, AssetBundleModel.Model.DataSource.ProviderName), "Select Asset Bundle Set");
